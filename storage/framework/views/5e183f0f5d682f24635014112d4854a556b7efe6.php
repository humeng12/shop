        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo e(auth()->user()->nickname); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo e(auth()->user()->name); ?> - 系统管理员
                  <small>最后登录:<?php echo e(date('Y-m-d H:i',strtotime(auth()->user()->updated_at))); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <!-- <li class="user-body">

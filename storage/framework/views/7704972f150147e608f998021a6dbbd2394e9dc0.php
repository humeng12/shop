...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row page-title-row" id="dangqian" style="margin:5px;">
                <div class="col-md-6">
                    <?php if($cid==0): ?>
                        <span style="margin:3px;" id="cid" attr="<?php echo e($cid); ?>" class="btn-flat text-info"> 顶级菜单</span>
                       <?php else: ?>
                        <span style="margin:3px;" id="cid"  attr="<?php echo e($cid); ?>" class="text-info"> <?php echo e($data->display_name); ?>
                ...
                <div class="col-md-6 text-right">
                    <a href="/admin/permission/<?php echo e($cid); ?>/create" class="btn btn-success btn-md"><i class="fa fa-plus-circle"></i> 添加权限 </a>
                </div>
            </div>

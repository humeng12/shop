...
<div class="form-group">
    ...
    <div class="col-md-6">
        ...
        <input type="hidden" class="form-control" name="cid" id="tag" value="<?php echo e($cid); ?>" autofocus>
    </div>
</div>
<div class="form-group">
...
<?php /*图标修改*/ ?>
    ...
    <div class="col-md-6">
        <!-- Button tag -->
        <button class="btn btn-default" name="icon" data-iconset="fontawesome" data-icon="<?php echo e($icon?$icon:'fa-sliders'); ?>" role="iconpicker"></button>
    </div>
